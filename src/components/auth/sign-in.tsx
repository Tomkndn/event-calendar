...
export function SigninForm() {
  ...
  return (
    <div className="flex justify-center items-center px-4 sm:px-6 lg:px-8">
      <Card className="w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl shadow-lg rounded-lg bg-white p-4 sm:p-6 md:p-8">
        <CardHeader>
          <CardTitle className="text-2xl sm:text-3xl font-semibold text-gray-800 text-center">
            Sign In
          </CardTitle>
          <CardDescription className="text-gray-600 text-sm sm:text-base text-center">
